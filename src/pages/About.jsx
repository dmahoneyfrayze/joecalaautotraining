...
const About = () => {
    return (
        ...
        >
            ...
            />
            <section className="about-hero" style={{ padding: '160px 0 100px', backgroundColor: 'var(--color-bg-light)' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4rem', alignItems: 'center' }}>
                        <div style={{ flex: '1 1 450px' }}>
                            ...
                            <h1 style={{ fontSize: '3.5rem', marginBottom: '2rem' }}>About Joe Cala</h1>
                            <p style={{ fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '1.5rem', opacity: 0.9 }}>
            ...
            <section className="mission" style={{ backgroundColor: 'var(--color-primary)', color: 'white' }}>
                <div className="container">
            ...
            <section className="story">
                <div className="container">
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <h2 className="section-title" style={{ textAlign: 'left' }}>A Purpose-Driven Journey</h2>
